/* enqueue, 1 thread, 40'000'000 elements :
 * 546 516 602 602 601 602 601 601 602 601 601 601 602 601 602 601 601 604 601 601 602 601 601 600 601 601 601 601 600 600 600 601 600 601 601 600 603 600 601 601
 *
 * enqueue, 4 threads, 4'000'000 elements / thread :
 * 1031 961 1033 1043 1031 1024 1002 968 1004 970 1019 1020 973 1023 1018 1018 995 996 968 967 1006 995 969 1014 1024 1019 1016 1020 1015 1021 1002 1000 1024 1001 1027 1023 993 1022 977 1021
 *
 * enqueue, 8 threads, 4'000'000 elements / thread :
 * 2004 1927 1995 2055 2054 2050 1970 1970 1966 1961 2037 2034 1955 1958 1965 2032 1959 1966 2047 1953 1963 1951 2041 2036 2045 2040 2033 2050 2042 2033 2045 2040 2034 2026 2047 2044 2036 2049 2042 2042
 */
...
//  override def companion: scala.collection.generic.GenericCompanion[ConcurrentUnrolledQueue] = ConcurrentUnrolledQueue
  ...
  def enqueue(elem: A): Unit = {
    ...
    var t = tail
    var i = t.addHint
    if (i < NODE_SIZE && t.compareAndSwapElem(i, null, elem)) {
      t.addHint = i + 1
      return
    }
